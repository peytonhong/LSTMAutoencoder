...
file = open("auto_save_profiles.txt","w")
file.close()

for seq_len in range(1,101):
    for hid_size in range(1,101):
        print("seq_length: {}, hidden_size: {}\n".format(seq_len, hid_size))
        seq_length = seq_len
        input_size = 1
        output_size = 1
        ...
        with tf.Session() as sess:
            ...
            # Test step
            loss, dec, pred = sess.run([loss, decoder_outputs, predictor_outputs], feed_dict={X: testX, X_predictor: testY})
        ...
        file = open("auto_save_profiles.txt","a")
        file.write("{},{},{}\n".format(seq_len, hid_size, loss))
        file.close()
